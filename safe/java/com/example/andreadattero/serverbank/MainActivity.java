package com.example.andreadattero.serverbank;
...
/*for(int i=0;i<9;i++){
            ...
            buttons[i].setOnClickListener((View view)->{
                bottoneNumerico(view);

            });
        }
        buttons[9].setOnClickListener((View view)->{
            cancellaTutto(view);
        });
        buttons[10].setOnClickListener((View view)->{
            bottoneNumerico(view);
        });
        buttons[11].setOnClickListener((View view)->{
            cancellaUltimo(view);
        });*/